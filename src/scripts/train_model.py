...
from config import (BATCH_SIZE, DATA_DIR, EPOCHS, LOG_DIR, MODEL_INPUT_SHAPE,
...
def train_model():
    ...
    model.fit(training_dataset, epochs=EPOCHS, validation_data=testing_dataset, callbacks=[tensorboard_callback])
